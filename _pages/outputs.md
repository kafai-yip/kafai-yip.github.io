...
- [Doubling Down on Exclusivity: Issues at the Syntax-Semantics Interface](https://kafai-yip.github.io/assets/docs/Yip_Dissertation.pdf), Yale University. [storyboards](https://kafai-yip.github.io/assets/docs/Yip_Dissertation_Appendix.pdf) [lingbuzz](https://lingbuzz.net/lingbuzz/010255)
...
1. [A quantifier-particle approach to exclusive focus particles in Yorùbá](https://lingbuzz.net/lingbuzz/008470). Accepted with minor revision, *Contemporary African Linguistics: Selected Papers from the 55th Annual Conference on African Linguistics*. [with [Bode Adedeji](https://bodeadedeji.github.io/)]
